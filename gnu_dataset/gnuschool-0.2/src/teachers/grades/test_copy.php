...
function echo_test_copy($id,$date,$test_id,$db_name,$period)
{
  $query = "select test from $db_name.scores where id=$id and
...
if ($yes_input)
{
  echo_test_copy($id,$date,$test_id,$db_name,$period);
}
else
{
