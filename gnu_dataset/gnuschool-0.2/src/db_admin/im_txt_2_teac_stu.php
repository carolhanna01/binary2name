...
function insert_all_passwords( $db_name="" )
{
  ...
  while ($row = mysql_fetch_array($result, MYSQL_ASSOC))
  {
    ...
    $query = "select * from $db_name.passwords where id=$id
              and period='$period'";
...
if (!$yes_input)
{
  ...
  echo "<b>Notes:
        <ul>
       <LI>The file name and path must be: /tmp/teacher_students.txt
       <LI>The file must contain teacher and student information. 
           A teacher section must be followed by that teacher's 
           student section.
...
$path_file = "/tmp/teacher_students.txt";
