...
function show_periods_attendance_table
            ($db_name="",$spanish_query="",$date_clause="",$in_by="")
{
...
$tag_title = "gnuschool.org Dismissal search";
...
$page_title = "Dismissal search&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
