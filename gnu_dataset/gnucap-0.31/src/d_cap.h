/*$Id: d_cap.h,v 21.14 2002/03/26 09:20:25 al Exp $ -*- C++ -*-
...
private: // override virtual
  ...
  int	   num_nodes()const	{untested(); return 4;}
...
public:
  ...
  ~DEV_FPOLY_CAP() 
	{delete [] _vy1; delete [] _vi0; delete [] _vi1; delete [] _n;}
private: // override virtual
  ...
  int	   num_nodes()const	{return _n_ports*2;}
