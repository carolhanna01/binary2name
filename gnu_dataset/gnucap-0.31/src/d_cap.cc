/*$Id: d_cap.cc,v 21.14 2002/03/26 09:20:25 al Exp $ -*- C++ -*-
...
/*--------------------------------------------------------------------------*/
bool DEV_FPOLY_CAP::do_tr_con_chk_and_q()
{
  q_load();
...
/*--------------------------------------------------------------------------*/
double DEV_FPOLY_CAP::tr_amps()const
{
  untested();
  double amps = _m0.c0;
  for (int i=1; i<=_n_ports; ++i) {
 ...
 */
void DEV_FPOLY_CAP::set_parameters(const std::string& Label, CARD *Owner,
