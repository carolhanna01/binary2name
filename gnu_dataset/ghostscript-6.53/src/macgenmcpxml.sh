...
# This file is part of GNU Ghostscript and is distributed
# under the terms of the GNU General Public License. See
# the file doc/COPYING for details.

# shell script to generate an xml project file for a configured
# ghostscript build, importable by Metrowerks CodeWarrior

# $Id: macgenmcpxml.sh,v 1.1.2.1 2001/07/27 21:34:17 giles Exp $
...
WriteSETTINGLIST()
{
	...
	WriteValueSetting MWProject_PPC_outfile "$TARGETNAME"
