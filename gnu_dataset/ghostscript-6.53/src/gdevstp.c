/*
  ...
  This file is a client for the gimp-print driver engine,
  supporting a variety of inkjet printers. Please see
  http://gimp-print.sourceforge.net/ for more information.
...
/*$Id: gdevstp.c,v 1.1.2.1 2002/02/02 20:43:03 giles Exp $ */
/* stp output driver */
