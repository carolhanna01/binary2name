/* Copyright (C) 1993, 2002 artofcode LLC.  All rights reserved.
...
/* $Id: gp_unifs.c,v 1.3.2.3 2002/01/22 06:01:46 giles Exp $ */
...
{	/* The -8 is for XXXXXX plus a possible final '/' and '-'. */
    ...
    strcat(fname, prefix);
    /* Prevent trailing X's in path from being converted by mk(s)temp. */
