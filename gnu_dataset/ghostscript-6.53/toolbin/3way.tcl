...
# $Id: 3way.tcl,v 1.3.2.1 2001/11/02 23:05:44 giles Exp $
...
proc filesame {f1 f2} {
	...
	if {[regexp {^([0-9]+)c([0-9]+)$} $l skip first last] &&
	    ...
	    } elseif {[regexp {\$Id: 3way.tcl,v 1.3.2.1 2001/11/02 23:05:44 giles Exp $a]} {
		if {[regexp {\$Id: 3way.tcl,v 1.3.2.1 2001/11/02 23:05:44 giles Exp $c]} {continue}
	    }
	}
	set same 0
	break
