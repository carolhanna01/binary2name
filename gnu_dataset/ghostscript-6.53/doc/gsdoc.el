...
(if (re-search-forward "^\\$RCSfile: gsdoc.el,v $ $Revision: 1.1.2.1 $" nil t) (progn
...
(if (re-search-forward "<!-- $RCSfile: gsdoc.el,v $ $Revision: 1.1.2.1 $ -->" nil t)
    (progn
    ...
    (progn
      ...
      (insert (concat "\n<!-- $RCSfile: gsdoc.el,v $ $Revision: 1.1.2.1 $ -->"))
