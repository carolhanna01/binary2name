...
(define x:XN-Required-Char-Set -190597671)
(define x:XN-Query-Orientation -190597632)
(define x:XN-Base-Font-Name -190597592)
(define x:XNOM-Automatic -190597559)
(define x:XN-Missing-Char-Set -190597530)
(define x:XN-Default-String -190597493)
(define x:XN-Orientation -190597459)
(define x:XN-Directional-Dependent-Drawing -190597430)
(define x:XN-Contextual-Drawing -190597365)
(define x:XN-Font-Info -190597323)
...
(define x:XN-Va-Nested-List -190597112)
(define x:XN-Query-Input-Style -190597077)
(define x:XN-Client-Window -190597038)
(define x:XN-Input-Style -190597006)
(define x:XN-Focus-Window -190596978)
(define x:XN-Resource-Name -190596948)
(define x:XN-Resource-Class -190596916)
(define x:XN-Geometry-Callback -190596882)
(define x:XN-Destroy-Callback -190596842)
(define x:XN-Filter-Events -190596804)
(define x:XN-Preedit-Start-Callback -190596772)
(define x:XN-Preedit-Done-Callback -190596723)
(define x:XN-Preedit-Draw-Callback -190596676)
(define x:XN-Preedit-Caret-Callback -190596629)
(define x:XN-Preedit-State-Notify-Callback -190596580)
(define x:XN-Preedit-Attributes -190596517)
(define x:XN-Status-Start-Callback -190596475)
(define x:XN-Status-Done-Callback -190596428)
(define x:XN-Status-Draw-Callback -190596383)
(define x:XN-Status-Attributes -190596338)
(define x:XN-Area -190596298)
(define x:XN-Area-Needed -190596283)
(define x:XN-Spot-Location -190596255)
(define x:XN-Colormap -190596223)
(define x:XN-Std-Colormap -190596200)
(define x:XN-Foreground -190596170)
(define x:XN-Background -190596143)
(define x:XN-Background-Pixmap -190596116)
(define x:XN-Font-Set -190596076)
(define x:XN-Line-Space -190596054)
(define x:XN-Cursor -190596028)
(define x:XN-Query-IM-Values-List -190596009)
(define x:XN-Query-IC-Values-List -190595965)
(define x:XN-Visible-Position -190595921)
(define x:XNR6-Preedit-Callback -190595883)
(define x:XN-String-Conversion-Callback -190595841)
(define x:XN-String-Conversion -190595784)
(define x:XN-Reset-State -190595744)
(define x:XN-Hot-Key -190595716)
(define x:XN-Hot-Key-State -190595696)
(define x:XN-Preedit-State -190595665)
(define x:XN-Separatorof-Nested-List -190595633)
