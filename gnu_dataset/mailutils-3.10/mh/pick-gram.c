...
#line 106 "pick-gram.c" /* yacc.c:339  */
...
union YYSTYPE
{
#line 47 "pick-gram.y" /* yacc.c:355  */

  char *string;
  node_t *node;
  regex_t regex;

#line 178 "pick-gram.c" /* yacc.c:355  */
};
...
#line 195 "pick-gram.c" /* yacc.c:358  */
...
/* Suppress an incorrect diagnostic about pick_yylval being uninitialized.  */
...
/* YYTRANSLATE[YYX] -- Symbol number corresponding to YYX as returned
   by pick_yylex, with out-of-bounds checking.  */
#define YYUNDEFTOK  2
...
/* YYTRANSLATE[TOKEN-NUM] -- Symbol number corresponding to TOKEN-NUM
   as returned by pick_yylex, without out-of-bounds checking.  */
...
static void
yy_reduce_print (yytype_int16 *yyssp, YYSTYPE *yyvsp, int pick_yyrule)
{
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 59 "pick-gram.y" /* yacc.c:1646  */
    {
	     parse_tree = NULL;
	   }
#line 1283 "pick-gram.c" /* yacc.c:1646  */
    break;

  case 3:
#line 63 "pick-gram.y" /* yacc.c:1646  */
    {
	     parse_tree = (yyvsp[0].node);
	   }
#line 1291 "pick-gram.c" /* yacc.c:1646  */
    break;

  case 5:
#line 70 "pick-gram.y" /* yacc.c:1646  */
    {
	     (pick_yyval.node) = pick_node_create (node_and, (yyvsp[-1].node), (yyvsp[0].node));
	   }
#line 1299 "pick-gram.c" /* yacc.c:1646  */
    break;

  case 7:
#line 77 "pick-gram.y" /* yacc.c:1646  */
    {
	     set_cflags ((yyvsp[0].string));
	   }
#line 1307 "pick-gram.c" /* yacc.c:1646  */
    break;

  case 8:
#line 83 "pick-gram.y" /* yacc.c:1646  */
    {
	     int rc = regcomp (&(pick_yyval.regex), (yyvsp[0].string), reg_flags|REG_NOSUB);
	     if (rc)
	       {
		 char errbuf[512];
		 regerror (rc, &(pick_yyval.regex), errbuf, sizeof (errbuf));
		 mu_error ("error compiling regex \"%s\": %s",
			   (yyvsp[0].string), errbuf);
		 YYERROR;
	       }
	   }
#line 1323 "pick-gram.c" /* yacc.c:1646  */
    break;

  case 9:
#line 97 "pick-gram.y" /* yacc.c:1646  */
    {
	     (pick_yyval.node) = (yyvsp[-1].node);
	   }
#line 1331 "pick-gram.c" /* yacc.c:1646  */
    break;

  case 10:
#line 101 "pick-gram.y" /* yacc.c:1646  */
    {
	     (pick_yyval.node) = pick_node_create (node_regex, (yyvsp[-1].string), regex_dup (&(yyvsp[0].regex)));
	   }
#line 1339 "pick-gram.c" /* yacc.c:1646  */
    break;

  case 11:
#line 105 "pick-gram.y" /* yacc.c:1646  */
    {
	     (pick_yyval.node) = pick_node_create (node_regex, NULL, regex_dup (&(yyvsp[0].regex)));
	   }
#line 1347 "pick-gram.c" /* yacc.c:1646  */
    break;

  case 12:
#line 109 "pick-gram.y" /* yacc.c:1646  */
    {
	     (pick_yyval.node) = pick_node_create (node_datefield, (yyvsp[0].string), NULL);
	   }
#line 1355 "pick-gram.c" /* yacc.c:1646  */
    break;

  case 13:
#line 113 "pick-gram.y" /* yacc.c:1646  */
    {
	     time_t t;
	     if (mu_parse_date ((yyvsp[0].string), &t, NULL))
	       {
		 mu_error (_("bad date format: %s"), (yyvsp[0].string));
		 exit (1);
	       }
	     (pick_yyval.node) = pick_node_create (node_before, NULL, NULL);
	     (pick_yyval.node)->v.time = t;
	   }
#line 1370 "pick-gram.c" /* yacc.c:1646  */
    break;

  case 14:
#line 124 "pick-gram.y" /* yacc.c:1646  */
    {
	     time_t t;
	     if (mu_parse_date ((yyvsp[0].string), &t, NULL))
	       {
...
#line 1385 "pick-gram.c" /* yacc.c:1646  */
    break;

  case 15:
#line 135 "pick-gram.y" /* yacc.c:1646  */
    {
	     (pick_yyval.node) = pick_node_create (node_and, (yyvsp[-2].node), (yyvsp[0].node));
	   }
#line 1393 "pick-gram.c" /* yacc.c:1646  */
    break;

  case 16:
#line 139 "pick-gram.y" /* yacc.c:1646  */
    {
	     (pick_yyval.node) = pick_node_create (node_or, (yyvsp[-2].node), (yyvsp[0].node));
	   }
#line 1401 "pick-gram.c" /* yacc.c:1646  */
    break;

  case 17:
#line 143 "pick-gram.y" /* yacc.c:1646  */
    {
	     (pick_yyval.node) = pick_node_create (node_not, (yyvsp[0].node), NULL);
	   }
#line 1409 "pick-gram.c" /* yacc.c:1646  */
    break;

  case 18:
#line 149 "pick-gram.y" /* yacc.c:1646  */
    {
	     nesting_level++;
	   }
#line 1417 "pick-gram.c" /* yacc.c:1646  */
    break;

  case 19:
#line 155 "pick-gram.y" /* yacc.c:1646  */
    {
	     nesting_level--;
	   }
#line 1425 "pick-gram.c" /* yacc.c:1646  */
    break;


#line 1429 "pick-gram.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 160 "pick-gram.y" /* yacc.c:1906  */
