...
#line 1 "mh_alias_gram.y" /* yacc.c:339  */
...
#line 175 "mh_alias_gram.c" /* yacc.c:339  */
...
union YYSTYPE
{
#line 110 "mh_alias_gram.y" /* yacc.c:355  */

  char *string;
  mu_list_t list;
  struct mh_alias *alias;

#line 229 "mh_alias_gram.c" /* yacc.c:355  */
};
...
#line 260 "mh_alias_gram.c" /* yacc.c:358  */
...
/* Suppress an incorrect diagnostic about ali_yylval being uninitialized.  */
...
/* YYTRANSLATE[YYX] -- Symbol number corresponding to YYX as returned
   by ali_yylex, with out-of-bounds checking.  */
#define YYUNDEFTOK  2
...
/* YYTRANSLATE[TOKEN-NUM] -- Symbol number corresponding to TOKEN-NUM
   as returned by ali_yylex, without out-of-bounds checking.  */
...
{
       0,   126,   126,   129,   133,   140,   143,   143,   151,   151,
     161,   162,   167,   172,   178,   183,   190,   196,   201
};
#endif
...
{
  "$end", "error", "$undefined", "EOL", "STRING", "':'", "';'", "'='",
  "'+'", "'*'", "','", "$accept", "input", "alias_list", "alias", "$@1",
  "$@2", "address_group", "address_list", "address", "string_list", YY_NULLPTR
};
#endif
...
{
       0,   256,   257,   258,   259,    58,    59,    61,    43,    42,
      44
};
# endif
...
#define yytable_value_is_error(Yytable_value) \
  ...
  /* YYPACT[STATE-NUM] -- Index in YYTABLE of the portion describing
     STATE-NUM.  */
static const yytype_int8 ali_yypact[] =
{
      -3,     1,     2,     5,    -9,    -9,    -9,    -9,    -3,    -4,
      -4,    -9,    -9,     6,     7,    -9,    -9,    -1,    -9,     8,
      -9,    -9,    -9,     9,    -9,    -9
...
static const yytype_uint8 ali_yytable[] =
{
      12,     1,     7,    13,    14,    15,     5,     6,     8,    23,
      21,    22,    24,    12,    20,    25,     0,     0,    11
};

static const yytype_int8 ali_yycheck[] =
{
       4,     4,     0,     7,     8,     9,     5,     6,     3,    10,
       4,     4,     4,     4,    10,    23,    -1,    -1,     8
};
...
{
       0,     4,    12,    13,    14,     5,     6,     0,     3,    15,
      16,    14,     4,     7,     8,     9,    17,    18,    19,    20,
      17,     4,     4,    10,     4,    19
};

  /* YYR1[YYN] -- Symbol number of symbol that rule YYN derives.  */
static const yytype_uint8 ali_yyr1[] =
{
       0,    11,    12,    13,    13,    14,    15,    14,    16,    14,
      17,    17,    17,    17,    18,    18,    19,    20,    20
};

  /* YYR2[YYN] -- Number of symbols on the right hand side of rule YYN.  */
static const yytype_uint8 ali_yyr2[] =
{
       0,     2,     1,     1,     3,     0,     0,     4,     0,     4,
       1,     2,     2,     1,     1,     3,     1,     1,     2
};
...
#define yyclearin       (ali_yychar = YYEMPTY)
#define YYEMPTY         (-2)
#define YYEOF           0
...
static void
yy_reduce_print (yytype_int16 *yyssp, YYSTYPE *yyvsp, YYLTYPE *yylsp, int ali_yyrule)
{
  unsigned long int yylno = yyrline[ali_yyrule];
  int yynrhs = ali_yyr2[ali_yyrule];
  int yyi;
...
{
  YYSIZE_T ali_yylen;
  for (ali_yylen = 0; yystr[ali_yylen]; ali_yylen++)
    continue;
  return ali_yylen;
}
#  endif
      ...
      if (!yypact_value_is_default (yyn))
        {
          ...
          /* Stay within bounds of both ali_yycheck and yytname.  */
          int yychecklim = YYLAST - yyn + 1;
          int yyxend = yychecklim < YYNTOKENS ? yychecklim : YYNTOKENS;
          int yyx;

          for (yyx = yyxbegin; yyx < yyxend; ++yyx)
            if (ali_yycheck[yyx + yyn] == yyx && yyx != YYTERROR
                && !yytable_value_is_error (ali_yytable[yyx + yyn]))
              {
...
/*------------------------------------------------------------.
| yynewstate -- Push a new state, which is found in ali_yystate.  |
`------------------------------------------------------------*/
 yynewstate:
...
# else
      ...
      {
        yytype_int16 *yyss1 = yyss;
        union ali_yyalloc *yyptr =
          (union ali_yyalloc *) YYSTACK_ALLOC (YYSTACK_BYTES (yystacksize));
        if (! yyptr)
          goto yyexhaustedlab;
...
yybackup:
  ...
  if (ali_yychar == YYEMPTY)
    {
      ...
      ali_yychar = ali_yylex ();
    }

  if (ali_yychar <= YYEOF)
    {
      ali_yychar = yytoken = YYEOF;
      YYDPRINTF ((stderr, "Now at end of input.\n"));
    }
  else
    {
      yytoken = YYTRANSLATE (ali_yychar);
      YY_SYMBOL_PRINT ("Next token is", yytoken, &ali_yylval, &ali_yylloc);
    }

  /* If the proper action on seeing token YYTOKEN is to reduce or to
     detect an error, take that action.  */
  yyn += yytoken;
  if (yyn < 0 || YYLAST < yyn || ali_yycheck[yyn] != yytoken)
    goto yydefault;
  yyn = ali_yytable[yyn];
  if (yyn <= 0)
    {
  ...
  YY_SYMBOL_PRINT ("Shifting", yytoken, &ali_yylval, &ali_yylloc);
...
yyreduce:
  ...
  ali_yyval = yyvsp[1-ali_yylen];

  /* Default location.  */
  YYLLOC_DEFAULT (yyloc, (yylsp - ali_yylen), ali_yylen);
  YY_REDUCE_PRINT (yyn);
  switch (yyn)
    {
        case 3:
#line 130 "mh_alias_gram.y" /* yacc.c:1646  */
    {
		 ali_append ((yyvsp[0].alias));
	       }
#line 1435 "mh_alias_gram.c" /* yacc.c:1646  */
    break;

  case 4:
#line 134 "mh_alias_gram.y" /* yacc.c:1646  */
    {
		 ali_append ((yyvsp[0].alias));
	       }
#line 1443 "mh_alias_gram.c" /* yacc.c:1646  */
    break;

  case 5:
#line 140 "mh_alias_gram.y" /* yacc.c:1646  */
    {
		 (ali_yyval.alias) = NULL;
	       }
#line 1451 "mh_alias_gram.c" /* yacc.c:1646  */
    break;

  case 6:
#line 143 "mh_alias_gram.y" /* yacc.c:1646  */
    { ali_verbatim (1); }
#line 1457 "mh_alias_gram.c" /* yacc.c:1646  */
    break;

  case 7:
#line 144 "mh_alias_gram.y" /* yacc.c:1646  */
    {
		 ali_verbatim (0);
		 (ali_yyval.alias) = mu_alloc (sizeof (*(ali_yyval.alias)));
		 (ali_yyval.alias)->name = (yyvsp[-3].string);
		 (ali_yyval.alias)->rcpt_list = (yyvsp[0].list);
		 (ali_yyval.alias)->inclusive = 0;
	       }
#line 1469 "mh_alias_gram.c" /* yacc.c:1646  */
    break;

  case 8:
#line 151 "mh_alias_gram.y" /* yacc.c:1646  */
    { ali_verbatim (1); }
#line 1475 "mh_alias_gram.c" /* yacc.c:1646  */
    break;

  case 9:
#line 152 "mh_alias_gram.y" /* yacc.c:1646  */
    {
		 ali_verbatim (0);
		 (ali_yyval.alias) = mu_alloc (sizeof (*(ali_yyval.alias)));
		 (ali_yyval.alias)->name = (yyvsp[-3].string);
...
#line 1487 "mh_alias_gram.c" /* yacc.c:1646  */
    break;

  case 11:
#line 163 "mh_alias_gram.y" /* yacc.c:1646  */
    {
		 (ali_yyval.list) = unix_group_to_list ((yyvsp[0].string));
		 free ((yyvsp[0].string));
	       }
#line 1496 "mh_alias_gram.c" /* yacc.c:1646  */
    break;

  case 12:
#line 168 "mh_alias_gram.y" /* yacc.c:1646  */
    {
		 (ali_yyval.list) = unix_gid_to_list ((yyvsp[0].string));
		 free ((yyvsp[0].string));
	       }
#line 1505 "mh_alias_gram.c" /* yacc.c:1646  */
    break;

  case 13:
#line 173 "mh_alias_gram.y" /* yacc.c:1646  */
    {
		 (ali_yyval.list) = unix_passwd_to_list ();
	       }
#line 1513 "mh_alias_gram.c" /* yacc.c:1646  */
    break;

  case 14:
#line 179 "mh_alias_gram.y" /* yacc.c:1646  */
    {
		 (ali_yyval.list) = list_create_or_die ();
		 mu_list_append ((ali_yyval.list), (yyvsp[0].string));
	       }
#line 1522 "mh_alias_gram.c" /* yacc.c:1646  */
    break;

  case 15:
#line 184 "mh_alias_gram.y" /* yacc.c:1646  */
    {
		 mu_list_append ((yyvsp[-2].list), (yyvsp[0].string));
		 (ali_yyval.list) = (yyvsp[-2].list);
	       }
#line 1531 "mh_alias_gram.c" /* yacc.c:1646  */
    break;

  case 16:
#line 191 "mh_alias_gram.y" /* yacc.c:1646  */
    {
		 (ali_yyval.string) = ali_list_to_string (&(yyvsp[0].list));
	       }
#line 1539 "mh_alias_gram.c" /* yacc.c:1646  */
    break;

  case 17:
#line 197 "mh_alias_gram.y" /* yacc.c:1646  */
    {
		 mu_list_create(&(ali_yyval.list));
		 mu_list_append((ali_yyval.list), (yyvsp[0].string));
	       }
#line 1548 "mh_alias_gram.c" /* yacc.c:1646  */
    break;

  case 18:
#line 202 "mh_alias_gram.y" /* yacc.c:1646  */
    {
		 mu_list_append((yyvsp[-1].list), (yyvsp[0].string));
		 (ali_yyval.list) = (yyvsp[-1].list);
	       }
#line 1557 "mh_alias_gram.c" /* yacc.c:1646  */
    break;


#line 1561 "mh_alias_gram.c" /* yacc.c:1646  */
      default: break;
    }
  ...
  YY_SYMBOL_PRINT ("-> $$ =", ali_yyr1[yyn], &ali_yyval, &yyloc);
  ...
  *++yylsp = yyloc;
  ...
  ali_yystate = yypgoto[yyn - YYNTOKENS] + *yyssp;
  if (0 <= ali_yystate && ali_yystate <= YYLAST && ali_yycheck[ali_yystate] == *yyssp)
    ali_yystate = ali_yytable[ali_yystate];
  else
    ali_yystate = yydefgoto[yyn - YYNTOKENS];
...
yyerrlab:
  ...
  yytoken = ali_yychar == YYEMPTY ? YYEMPTY : YYTRANSLATE (ali_yychar);
...
yyerrorlab:
  ...
  yyerror_range[1] = yylsp[1-ali_yylen];
  ...
  for (;;)
    {
      ...
      if (!yypact_value_is_default (yyn))
        {
          yyn += YYTERROR;
          if (0 <= yyn && yyn <= YYLAST && ali_yycheck[yyn] == YYTERROR)
            {
              yyn = ali_yytable[yyn];
              if (0 < yyn)
                break;
      ...
      yydestruct ("Error: popping",
                  yystos[ali_yystate], yyvsp, yylsp);
      YYPOPSTACK (1);
      ali_yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
...
#line 208 "mh_alias_gram.y" /* yacc.c:1906  */
