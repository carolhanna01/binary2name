...
/* Suppress an incorrect diagnostic about mu_cfg_yylval being uninitialized.  */
...
/* YYTRANSLATE[YYX] -- Symbol number corresponding to YYX as returned
   by mu_cfg_yylex, with out-of-bounds checking.  */
#define YYUNDEFTOK  2
...
/* YYTRANSLATE[TOKEN-NUM] -- Symbol number corresponding to TOKEN-NUM
   as returned by mu_cfg_yylex, without out-of-bounds checking.  */
...
static void
yy_reduce_print (yytype_int16 *yyssp, YYSTYPE *yyvsp, YYLTYPE *yylsp, int mu_cfg_yyrule)
{
...
#line 203 "parser.y" /* yacc.c:1646  */
    {
	    ...
	    mu_list_append ((mu_cfg_yyval.nodelist), (yyvsp[0].pnode));
	  }
...
#line 208 "parser.y" /* yacc.c:1646  */
    {
	    ...
	    (mu_cfg_yyval.nodelist) = (yyvsp[-1].nodelist);
...
#line 220 "parser.y" /* yacc.c:1646  */
    {
	    ...
	    lr.beg = (yylsp[-2]).beg;
	    lr.end = (yylsp[0]).end;
	    (mu_cfg_yyval.pnode) = mu_cfg_alloc_node (mu_cfg_node_param, &lr, (yyvsp[-2].string), (yyvsp[-1].pvalue), NULL);
	  }
...
#line 229 "parser.y" /* yacc.c:1646  */
    {
	    ...
	    lr.beg = (yylsp[-4]).beg;
	    lr.end = (yylsp[0]).end;
	    (mu_cfg_yyval.pnode) = mu_cfg_alloc_node (mu_cfg_node_statement, &lr, (yyvsp[-4].string), (yyvsp[-3].pvalue), NULL);
	  }
...
#line 236 "parser.y" /* yacc.c:1646  */
    {
	    ...
	    lr.beg = (yylsp[-5]).beg;
	    lr.end = (yylsp[0]).end;
	    (mu_cfg_yyval.pnode) = mu_cfg_alloc_node (mu_cfg_node_statement, &lr, (yyvsp[-5].string), (yyvsp[-4].pvalue), (yyvsp[-2].nodelist));
	    mu_list_foreach ((yyvsp[-2].nodelist), _node_set_parent, (mu_cfg_yyval.pnode));
	  }
...
#line 256 "parser.y" /* yacc.c:1646  */
    {
	    ...
	    if (n == 1)
	      {
		mu_list_get ((yyvsp[0].list), 0, (void**) &(mu_cfg_yyval.pvalue));
	      }
	    else
	      {
		size_t i;
...
#line 291 "parser.y" /* yacc.c:1646  */
    {
	    ...
	    mu_list_append ((mu_cfg_yyval.list), config_value_dup (&(yyvsp[0].value))); /* FIXME */
	  }
...
#line 307 "parser.y" /* yacc.c:1646  */
    {
	      ...
	      (mu_cfg_yyval.value).v.string = (yyvsp[0].string);
	  }
...
#line 312 "parser.y" /* yacc.c:1646  */
    {
	      ...
	      (mu_cfg_yyval.value).v.list = (yyvsp[0].list);
	  }
...
#line 348 "parser.y" /* yacc.c:1646  */
    {
	    ...
	    mu_list_append ((mu_cfg_yyval.list), (yyvsp[0].string));
	  }
...
#line 353 "parser.y" /* yacc.c:1646  */
    {
	    ...
	    (mu_cfg_yyval.list) = (yyvsp[-1].list);
	  }
...
#line 364 "parser.y" /* yacc.c:1646  */
    {
	      (mu_cfg_yyval.list) = (yyvsp[-2].list);
	  }
...
#line 370 "parser.y" /* yacc.c:1646  */
    {
	    mu_list_create (&(mu_cfg_yyval.list));
	    mu_list_append ((mu_cfg_yyval.list), config_value_dup (&(yyvsp[0].value)));
	  }
