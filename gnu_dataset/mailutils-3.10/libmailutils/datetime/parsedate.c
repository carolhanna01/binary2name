...
#line 260 "parsedate.c" /* yacc.c:339  */
...
/* Suppress an incorrect diagnostic about pd_yylval being uninitialized.  */
...
/* YYTRANSLATE[YYX] -- Symbol number corresponding to YYX as returned
   by pd_yylex, with out-of-bounds checking.  */
#define YYUNDEFTOK  2
...
/* YYTRANSLATE[TOKEN-NUM] -- Symbol number corresponding to TOKEN-NUM
   as returned by pd_yylex, without out-of-bounds checking.  */
...
{
       0,   218,   218,   225,   229,   235,   241,   284,   285,   286,
     287,   290,   296,   303,   311,   319,   330,   336,   342,   350,
     356,   362,   370,   376,   396,   404,   421,   427,   434,   440,
     447,   462,   472,   476,   482,   490,   495,   500,   505,   510,
...
static void
yy_reduce_print (yytype_int16 *yyssp, YYSTYPE *yyvsp, int pd_yyrule)
{
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 219 "parsedate.y" /* yacc.c:1646  */
    {
	    pd = (yyvsp[0].datespec);
	  }
#line 1482 "parsedate.c" /* yacc.c:1646  */
  ...
  case 3:
#line 225 "parsedate.y" /* yacc.c:1646  */
    {
...
#line 1491 "parsedate.c" /* yacc.c:1646  */
  ...
  case 4:
#line 230 "parsedate.y" /* yacc.c:1646  */
    {
	    if (pd_date_union (&(yyvsp[-1].datespec).date, &(yyvsp[0].date)))
	      YYERROR;
	    (pd_yyval.datespec) = (yyvsp[-1].datespec);
	  }
...
#line 1556 "parsedate.c" /* yacc.c:1646  */
  ...
  case 11:
#line 291 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_HOUR ((pd_yyval.date), (yyvsp[-1].number));
	    SET_MERIDIAN ((pd_yyval.date), (yyvsp[0].meridian));
	  }
...
#line 297 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_HOUR ((pd_yyval.date), (yyvsp[-3].number));
	    SET_MINUTE ((pd_yyval.date), (yyvsp[-1].number));
	    SET_MERIDIAN ((pd_yyval.date), (yyvsp[0].meridian));
	  }
#line 1577 "parsedate.c" /* yacc.c:1646  */
  ...
  case 13:
#line 304 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_HOUR ((pd_yyval.date), (yyvsp[-3].number));
	    SET_MINUTE ((pd_yyval.date), (yyvsp[-1].number));
	    SET_MERIDIAN ((pd_yyval.date), MER24);
	    SET_TZ_PACK ((pd_yyval.date), (yyvsp[0].number));
	  }
...
#line 312 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_HOUR ((pd_yyval.date), (yyvsp[-5].number));
	    SET_MINUTE ((pd_yyval.date), (yyvsp[-3].number));
	    SET_SECOND ((pd_yyval.date), (yyvsp[-1].number));
	    SET_MERIDIAN ((pd_yyval.date), (yyvsp[0].meridian));
	  }
#line 1601 "parsedate.c" /* yacc.c:1646  */
  ...
  case 15:
#line 320 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_HOUR ((pd_yyval.date), (yyvsp[-5].number));
	    SET_MINUTE ((pd_yyval.date), (yyvsp[-3].number));
...
#line 331 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_TZ ((pd_yyval.date), (yyvsp[0].tz).delta);
	    (pd_yyval.date).tzname = (yyvsp[0].tz).name;
	  }
#line 1624 "parsedate.c" /* yacc.c:1646  */
    break;

  case 17:
#line 337 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_TZ ((pd_yyval.date), (yyvsp[0].tz).delta - 60);
	    (pd_yyval.date).tzname = (yyvsp[0].tz).name;
	  }
#line 1634 "parsedate.c" /* yacc.c:1646  */
  ...
  case 18:
#line 343 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_TZ ((pd_yyval.date), (yyvsp[-1].tz).delta - 60);
	    (pd_yyval.date).tzname = (yyvsp[-1].tz).name;
	  }
#line 1644 "parsedate.c" /* yacc.c:1646  */
    break;

  case 19:
#line 351 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_ORDINAL ((pd_yyval.date), 1);
	    SET_NUMBER ((pd_yyval.date), (yyvsp[0].number));
	  }
#line 1654 "parsedate.c" /* yacc.c:1646  */
    break;

  case 20:
#line 357 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_ORDINAL ((pd_yyval.date), 1);
	    SET_NUMBER ((pd_yyval.date), (yyvsp[-1].number));
	  }
#line 1664 "parsedate.c" /* yacc.c:1646  */
    break;

  case 21:
#line 363 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_ORDINAL ((pd_yyval.date), (yyvsp[-1].number));
	    SET_NUMBER ((pd_yyval.date), (yyvsp[0].number));
	  }
#line 1674 "parsedate.c" /* yacc.c:1646  */
  ...
  case 22:
#line 371 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_MONTH ((pd_yyval.date), (yyvsp[-2].number));
	    SET_DAY ((pd_yyval.date), (yyvsp[0].number));
	  }
#line 1684 "parsedate.c" /* yacc.c:1646  */
    break;

  case 23:
#line 377 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    ...
	    if ((yyvsp[-4].number) >= 1000)
	      {
		SET_YEAR ((pd_yyval.date), (yyvsp[-4].number));
		SET_MONTH ((pd_yyval.date), (yyvsp[-2].number));
		SET_DAY ((pd_yyval.date), (yyvsp[0].number));
	      }
	    else
	      {
		SET_MONTH ((pd_yyval.date), (yyvsp[-4].number));
		SET_DAY ((pd_yyval.date), (yyvsp[-2].number));
		SET_YEAR ((pd_yyval.date), (yyvsp[0].number));
	      }
	  }
#line 1708 "parsedate.c" /* yacc.c:1646  */
  ...
  case 24:
#line 397 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    /* ISO 8601 format.  yyyy-mm-dd.  */
	    SET_YEAR ((pd_yyval.date), (yyvsp[-2].number));
	    SET_MONTH ((pd_yyval.date), -(yyvsp[-1].number));
	    SET_DAY ((pd_yyval.date), -(yyvsp[0].number));
	  }
#line 1720 "parsedate.c" /* yacc.c:1646  */
  ...
  case 25:
#line 405 "parsedate.y" /* yacc.c:1646  */
    {
...
#line 1741 "parsedate.c" /* yacc.c:1646  */
  ...
  case 26:
#line 422 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_MONTH ((pd_yyval.date), (yyvsp[-1].number));
	    SET_DAY ((pd_yyval.date), (yyvsp[0].number));
...
#line 1751 "parsedate.c" /* yacc.c:1646  */
  ...
  case 27:
#line 428 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_MONTH ((pd_yyval.date), (yyvsp[-3].number));
	    SET_DAY ((pd_yyval.date), (yyvsp[-2].number));
	    SET_YEAR ((pd_yyval.date), (yyvsp[0].number));
	  }
#line 1762 "parsedate.c" /* yacc.c:1646  */
  ...
  case 28:
#line 435 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_MONTH ((pd_yyval.date), (yyvsp[0].number));
	    SET_DAY ((pd_yyval.date), (yyvsp[-1].number));
	  }
#line 1772 "parsedate.c" /* yacc.c:1646  */
    break;

  case 29:
#line 441 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_MONTH ((pd_yyval.date), (yyvsp[-1].number));
	    SET_DAY ((pd_yyval.date), (yyvsp[-2].number));
...
#line 1783 "parsedate.c" /* yacc.c:1646  */
  ...
  case 30:
#line 448 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));

	    SET_ORDINAL ((pd_yyval.date), 1);
	    SET_NUMBER ((pd_yyval.date), (yyvsp[-4].number));

	    SET_MONTH ((pd_yyval.date), (yyvsp[-3].number));
	    SET_DAY ((pd_yyval.date), (yyvsp[-2].number));
	    SET_YEAR ((pd_yyval.date), (yyvsp[0].number));
	    if (pd_date_union (&(pd_yyval.date), &(yyvsp[-1].date)))
	      YYERROR;
	  }
#line 1800 "parsedate.c" /* yacc.c:1646  */
  ...
  case 31:
#line 463 "parsedate.y" /* yacc.c:1646  */
    {
	    ...
	    (pd_yyval.date) = (yyvsp[-1].date);
	  }
#line 1814 "parsedate.c" /* yacc.c:1646  */
    break;

  case 33:
#line 477 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    if (pd_date_union (&(pd_yyval.date), &(yyvsp[0].date)))
	      YYERROR;
	  }
#line 1824 "parsedate.c" /* yacc.c:1646  */
  ...
  case 34:
#line 483 "parsedate.y" /* yacc.c:1646  */
    {
...
#line 1834 "parsedate.c" /* yacc.c:1646  */
  ...
  case 35:
#line 491 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_YEAR ((pd_yyval.date), (yyvsp[-1].number) * (yyvsp[0].number));
	  }
#line 1843 "parsedate.c" /* yacc.c:1646  */
    break;

  case 36:
#line 496 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_YEAR ((pd_yyval.date), (yyvsp[-1].number) * (yyvsp[0].number));
	  }
#line 1852 "parsedate.c" /* yacc.c:1646  */
  ...
  case 37:
#line 501 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_YEAR ((pd_yyval.date), (yyvsp[0].number));
	  }
...
#line 506 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_MONTH ((pd_yyval.date), (yyvsp[-1].number) * (yyvsp[0].number));
	  }
#line 1870 "parsedate.c" /* yacc.c:1646  */
    break;

  case 39:
#line 511 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_MONTH ((pd_yyval.date), (yyvsp[-1].number) * (yyvsp[0].number));
	  }
#line 1879 "parsedate.c" /* yacc.c:1646  */
  ...
  case 40:
#line 516 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_MONTH ((pd_yyval.date), (yyvsp[0].number));
	  }
...
#line 521 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_DAY ((pd_yyval.date), (yyvsp[-1].number) * (yyvsp[0].number));
	  }
#line 1897 "parsedate.c" /* yacc.c:1646  */
    break;

  case 42:
#line 526 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_DAY ((pd_yyval.date), (yyvsp[-1].number) * (yyvsp[0].number));
	  }
#line 1906 "parsedate.c" /* yacc.c:1646  */
  ...
  case 43:
#line 531 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_DAY ((pd_yyval.date), (yyvsp[0].number));
	  }
...
#line 536 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_HOUR ((pd_yyval.date), (yyvsp[-1].number) * (yyvsp[0].number));
	  }
#line 1924 "parsedate.c" /* yacc.c:1646  */
    break;

  case 45:
#line 541 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_HOUR ((pd_yyval.date), (yyvsp[-1].number) * (yyvsp[0].number));
	  }
#line 1933 "parsedate.c" /* yacc.c:1646  */
  ...
  case 46:
#line 546 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_HOUR ((pd_yyval.date), (yyvsp[0].number));
	  }
...
#line 551 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_MINUTE ((pd_yyval.date), (yyvsp[-1].number) * (yyvsp[0].number));
	  }
#line 1951 "parsedate.c" /* yacc.c:1646  */
    break;

  case 48:
#line 556 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_MINUTE ((pd_yyval.date), (yyvsp[-1].number) * (yyvsp[0].number));
	  }
#line 1960 "parsedate.c" /* yacc.c:1646  */
  ...
  case 49:
#line 561 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_MINUTE ((pd_yyval.date), (yyvsp[0].number));
	  }
#line 1969 "parsedate.c" /* yacc.c:1646  */
    break;

  case 50:
#line 566 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_SECOND ((pd_yyval.date), (yyvsp[-1].number) * (yyvsp[0].number));
	  }
#line 1978 "parsedate.c" /* yacc.c:1646  */
    break;

  case 51:
#line 571 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_SECOND ((pd_yyval.date), (yyvsp[-1].number) * (yyvsp[0].number));
	  }
#line 1987 "parsedate.c" /* yacc.c:1646  */
  ...
  case 52:
#line 576 "parsedate.y" /* yacc.c:1646  */
    {
	    DATE_INIT ((pd_yyval.date));
	    SET_SECOND ((pd_yyval.date), (yyvsp[0].number));
	  }
#line 1996 "parsedate.c" /* yacc.c:1646  */
    break;

  case 53:
#line 583 "parsedate.y" /* yacc.c:1646  */
    {
...
#line 2004 "parsedate.c" /* yacc.c:1646  */
  ...
  case 54:
#line 587 "parsedate.y" /* yacc.c:1646  */
    {
	    (pd_yyval.meridian) = (yyvsp[0].meridian);
	  }
...
#line 592 "parsedate.y" /* yacc.c:1906  */
