...
static char rcsid[] = "$Id: rpc_scan.c,v 1.1.1.1 2005/10/28 14:46:46 k0ro Exp $";
#endif
...
static void unget_token(), findstrconst(), findconst(), findkind(),
	printdirective(), docppline();
static int cppline(), directive();
