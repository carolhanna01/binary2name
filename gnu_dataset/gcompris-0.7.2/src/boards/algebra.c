/* gcompris - algebra.c
 *
 * Time-stamp: <2001/09/12 23:44:41 bruno>
 *
...
static GList *item_button_list = NULL;
...
static void algebra_create_buttons(GnomeCanvasGroup *parent);
...
static gint item_event_horver(GnomeCanvasItem *item, GdkEvent *event, gpointer data);
  ...
  if(agcomprisBoard!=NULL)
    {
      ...
      algebra_create_buttons(gnome_canvas_root(gcomprisBoard->canvas));
...
static void algebra_next_level() 
{
  ...
  /* Try the next level */
  algebra_create_item(gnome_canvas_root(gcomprisBoard->canvas));
...
static void algebra_create_buttons(GnomeCanvasGroup *parent)
{
  ...
  double y_offset;
  double x_offset = 20;
  static char plus_operation[1]; 
  static char minus_operation[1];
  static char by_operation[1];
  static char divide_operation[1];

  plus_operation[0]   = PLUSSIGNFILE;
  minus_operation[0]  = MINUSSIGNFILE;
  by_operation[0]     = BYSIGNFILE;
  divide_operation[0] = DIVIDESIGNFILE;

  /*----- PLUS -----*/
  button_pixmap = gcompris_load_pixmap("gcompris/buttons/button.png");
  y_offset = (double)gdk_pixbuf_get_height(button_pixmap) + 20;
  item = gnome_canvas_item_new (parent,
				gnome_canvas_pixbuf_get_type (),
				"pixbuf",  button_pixmap, 
				"x", x_offset,
				"y", (double) gcomprisBoard->height/4,
				"width", (double)  gdk_pixbuf_get_width(button_pixmap),
				"height", (double) gdk_pixbuf_get_height(button_pixmap),
				NULL);
  item_button_list = g_list_append (item_button_list, item);

  gtk_signal_connect(GTK_OBJECT(item), "event",
		     (GtkSignalFunc) item_event_valid,
		     &plus_operation);
  gcompris_set_image_focus(button_pixmap, FALSE);
  gtk_signal_connect(GTK_OBJECT(item), "event",
		     (GtkSignalFunc) gcompris_item_event_focus,
		     button_pixmap);

  algebra_pixmap = gcompris_load_operation_pixmap(PLUSSIGNFILE);
  item = gnome_canvas_item_new (parent,
				gnome_canvas_pixbuf_get_type (),
				"pixbuf", algebra_pixmap, 
				"x", (double) x_offset + (gdk_pixbuf_get_width(button_pixmap) 
							  - gdk_pixbuf_get_width(algebra_pixmap))/2,
				"y", (double) gcomprisBoard->height/4 + 
				(gdk_pixbuf_get_height(button_pixmap) 
				 -  gdk_pixbuf_get_height(algebra_pixmap))/2,
				"width", (double)  gdk_pixbuf_get_width(algebra_pixmap),
				"height", (double) gdk_pixbuf_get_height(algebra_pixmap),
				NULL);
  gdk_pixbuf_unref(algebra_pixmap);
  ...
  gtk_signal_connect(GTK_OBJECT(item), "event",
		     (GtkSignalFunc) item_event_valid,
		     &plus_operation);
  gcompris_set_image_focus(algebra_pixmap, FALSE);
  gtk_signal_connect(GTK_OBJECT(item), "event",
		     (GtkSignalFunc) gcompris_item_event_focus,
		     algebra_pixmap);
  ...
  item = gnome_canvas_item_new (parent,
				...
				"pixbuf",  button_pixmap, 
				"x", x_offset,
				"y", (double) gcomprisBoard->height/4 + y_offset,
				"width", (double)  gdk_pixbuf_get_width(button_pixmap),
				"height", (double) gdk_pixbuf_get_height(button_pixmap),
				NULL);
  item_button_list = g_list_append (item_button_list, item);
  ...
  algebra_pixmap = gcompris_load_operation_pixmap(MINUSSIGNFILE);
  item = gnome_canvas_item_new (parent,
				gnome_canvas_pixbuf_get_type (),
				"pixbuf", algebra_pixmap, 
				"x", (double) x_offset + (gdk_pixbuf_get_width(button_pixmap) 
							  - gdk_pixbuf_get_width(algebra_pixmap))/2,
				"y", (double) gcomprisBoard->height/4 + y_offset +
				(gdk_pixbuf_get_height(button_pixmap) -  gdk_pixbuf_get_height(algebra_pixmap))/2,
				"width", (double)  gdk_pixbuf_get_width(algebra_pixmap),
				"height", (double) gdk_pixbuf_get_height(algebra_pixmap),
				NULL);
  gdk_pixbuf_unref(algebra_pixmap);
  ...
  item = gnome_canvas_item_new (parent,
				...
				"pixbuf",  button_pixmap, 
				"x", x_offset,
				"y", (double) gcomprisBoard->height/4 + y_offset*2,
				"width", (double)  gdk_pixbuf_get_width(button_pixmap),
				"height", (double) gdk_pixbuf_get_height(button_pixmap),
				NULL);
  item_button_list = g_list_append (item_button_list, item);
  ...
  algebra_pixmap = gcompris_load_operation_pixmap(BYSIGNFILE);
  item = gnome_canvas_item_new (parent,
				gnome_canvas_pixbuf_get_type (),
				"pixbuf", algebra_pixmap, 
				"x", (double) x_offset + (gdk_pixbuf_get_width(button_pixmap) - 
  ...
  item = gnome_canvas_item_new (parent,
				...
				"pixbuf",  button_pixmap, 
				"x", x_offset,
				"y", (double) gcomprisBoard->height/4 + y_offset*3,
				"width", (double)  gdk_pixbuf_get_width(button_pixmap),
				"height", (double) gdk_pixbuf_get_height(button_pixmap),
				NULL);
  item_button_list = g_list_append (item_button_list, item);
  ...
  algebra_pixmap = gcompris_load_operation_pixmap(DIVIDESIGNFILE); 
  item = gnome_canvas_item_new (parent,
				gnome_canvas_pixbuf_get_type (),
				"pixbuf", algebra_pixmap, 
				"x", (double) x_offset + (gdk_pixbuf_get_width(button_pixmap) 
  ...
  /*----- HORIZONTAL / VERTICAL LAYOUT SELECTION -----*/
  item = gnome_canvas_item_new (parent,
				gnome_canvas_pixbuf_get_type (),
				"pixbuf",  button_pixmap, 
				"x", x_offset,
				"y", (double) gcomprisBoard->height/4 + y_offset*4 + 20,
				"width", (double)  gdk_pixbuf_get_width(button_pixmap),
				"height", (double) gdk_pixbuf_get_height(button_pixmap),
				NULL);
  item_button_list = g_list_append (item_button_list, item);
  ...
  gtk_signal_connect(GTK_OBJECT(item), "event",
		     (GtkSignalFunc) item_event_horver,
		     NULL);
  gcompris_set_image_focus(button_pixmap, FALSE);
  gtk_signal_connect(GTK_OBJECT(item), "event",
		     (GtkSignalFunc) gcompris_item_event_focus,
  ...
  algebra_pixmap = gcompris_load_pixmap("gcompris/buttons/horver.png");
  item = gnome_canvas_item_new (parent,
				gnome_canvas_pixbuf_get_type (),
				"pixbuf", algebra_pixmap, 
				"x", (double) x_offset + (gdk_pixbuf_get_width(button_pixmap) 
...
/* Callback for the ok and operation buttons */
static gint
item_event_valid(GnomeCanvasItem *item, GdkEvent *event, gpointer data)
{
  ...
  switch (event->type) 
    ...
    case GDK_BUTTON_PRESS:
      if(currentOperation==((char *)data)[0])
	{
	  return FALSE;
	}
      else 
	{
	  currentOperation=((char *)data)[0];
	  init_operation();
	  algebra_next_level();
	}
      gcompris_play_sound (SOUNDLISTFILE, "gobble");
...
/* Callback for the horizontal / vertical layout change */
static gint item_event_horver(GnomeCanvasItem *item, GdkEvent *event, gpointer data)
{
  switch (event->type) 
    {
