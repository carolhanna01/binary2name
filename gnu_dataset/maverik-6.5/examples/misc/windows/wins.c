...
int keyEvent(MAV_object *o, MAV_keyboardEvent *ke)
{
  if (ke->movement==MAV_PRESSED) { /* Only consider button presses */
    ...
    case 'w': /* Create a new window */
      mav_windowNew(200, 200, 200, 200, "new", NULL); /* ignore MAV_window return value, we never directly use it */
      break;
      
    case 'd': /* Delete a window */
      mav_windowDelete(ke->win);
      break;
    }
  }
