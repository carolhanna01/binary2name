...
/* d Define to 1, if `gzip' is available, otherwise 0. */
#define HAVE_GZIP 1
...
/* Name of package */
#define PACKAGE "3DLDF"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "Laurence.Finston@gmx.de"

/* Define to the full name of this package. */
#define PACKAGE_NAME "GNU 3DLDF"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "GNU 3DLDF 2.0.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "3DLDF"

/* Define to the home page for this package. */
#define PACKAGE_URL "http://www.gnu.org/software/3DLDF/"
