...
#define INT_BIN_OP(op, noOverflow) {            \
    ...
    if COMMON (RECEIVER_IS_INT(oop1) && IS_INT(oop2)) {\
      ...
      iarg2 = TO_INT(oop2);			\
						\
      op;                                       \
      if COMMON (noOverflow || !INT_OVERFLOW(iarg1)) {	\
        PUSH_INT(iarg1);			\
        PRIM_SUCCEEDED;				\
      }                                         \
    }						\
...
static intptr_t
VMpr_Processor_signalAtMilliseconds (int id ATTRIBUTE_UNUSED,
                                     volatile int numArgs ATTRIBUTE_UNUSED);
          ...
          && _gst_log2_sizes[OOP_INSTANCE_SPEC (oopVec[1]) & ISP_SHAPE] == 0)
	{
	  ...
	  if (to >= from - 1
	      ...
	      do
		{
	      ...
	      while ((result == -1) && is_socket_error (EINTR));
...
unsigned char
_gst_primitives_md5[16] = { 181, 73, 214, 180, 235, 187, 201, 230,
                            174, 81, 31, 23, 126, 76, 240, 192 };
...
_gst_init_primitives()
{
  ...
  _gst_default_primitive_table[141].name = "VMpr_Time_millisecondClock";
  _gst_default_primitive_table[141].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[141].id = 0;
  _gst_default_primitive_table[141].func = VMpr_Time_millisecondClock;
  _gst_default_primitive_table[142].name = "VMpr_Processor_signalAtMilliseconds";
  _gst_default_primitive_table[142].attributes = PRIM_SUCCEED | PRIM_FAIL | PRIM_CHECK_INTERRUPT;
  _gst_default_primitive_table[142].id = 0;
  _gst_default_primitive_table[142].func = VMpr_Processor_signalAtMilliseconds;
  _gst_default_primitive_table[143].name = "VMpr_Processor_isTimeoutProgrammed";
  _gst_default_primitive_table[143].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[143].id = 0;
  _gst_default_primitive_table[143].func = VMpr_Processor_isTimeoutProgrammed;
  _gst_default_primitive_table[144].name = "VMpr_String_similarityTo";
  _gst_default_primitive_table[144].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[144].id = 0;
  _gst_default_primitive_table[144].func = VMpr_String_similarityTo;
  _gst_default_primitive_table[145].name = "VMpr_String_hash";
  _gst_default_primitive_table[145].attributes = PRIM_CHECKS_RECEIVER;
  _gst_default_primitive_table[145].id = 0;
  _gst_default_primitive_table[145].func = VMpr_String_hash;
  _gst_default_primitive_table[146].name = "VMpr_ArrayedCollection_equal";
  _gst_default_primitive_table[146].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[146].id = 0;
  _gst_default_primitive_table[146].func = VMpr_ArrayedCollection_equal;
  _gst_default_primitive_table[147].name = "VMpr_ArrayedCollection_indexOfStartingAt";
  _gst_default_primitive_table[147].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[147].id = 0;
  _gst_default_primitive_table[147].func = VMpr_ArrayedCollection_indexOfStartingAt;
  _gst_default_primitive_table[148].name = "VMpr_ArrayedCollection_replaceFromToWithStartingAt";
  _gst_default_primitive_table[148].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[148].id = 0;
  _gst_default_primitive_table[148].func = VMpr_ArrayedCollection_replaceFromToWithStartingAt;
  _gst_default_primitive_table[149].name = "VMpr_Object_identity";
  _gst_default_primitive_table[149].attributes = PRIM_SUCCEED | PRIM_INLINED;
  _gst_default_primitive_table[149].id = 110;
  _gst_default_primitive_table[149].func = VMpr_Object_identity;
  _gst_default_primitive_table[150].name = "VMpr_Object_class";
  _gst_default_primitive_table[150].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[150].id = 111;
  _gst_default_primitive_table[150].func = VMpr_Object_class;
  _gst_default_primitive_table[151].name = "VMpr_ObjectMemory_quit";
  _gst_default_primitive_table[151].attributes = PRIM_FAIL;
  _gst_default_primitive_table[151].id = 0;
  _gst_default_primitive_table[151].func = VMpr_ObjectMemory_quit;
  _gst_default_primitive_table[152].name = "VMpr_ObjectMemory_abort";
  _gst_default_primitive_table[152].attributes = PRIM_FAIL;
  _gst_default_primitive_table[152].id = 0;
  _gst_default_primitive_table[152].func = VMpr_ObjectMemory_abort;
  _gst_default_primitive_table[153].name = "VMpr_Dictionary_at";
  _gst_default_primitive_table[153].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[153].id = 0;
  _gst_default_primitive_table[153].func = VMpr_Dictionary_at;
  _gst_default_primitive_table[154].name = "VMpr_Object_bootstrapError";
  _gst_default_primitive_table[154].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[154].id = 0;
  _gst_default_primitive_table[154].func = VMpr_Object_bootstrapException;
  _gst_default_primitive_table[155].name = "VMpr_Object_bootstrapDNU";
  _gst_default_primitive_table[155].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[155].id = -1;
  _gst_default_primitive_table[155].func = VMpr_Object_bootstrapException;
  _gst_default_primitive_table[156].name = "VMpr_Character_create";
  _gst_default_primitive_table[156].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[156].id = 0;
  _gst_default_primitive_table[156].func = VMpr_Character_create;
  _gst_default_primitive_table[157].name = "VMpr_UnicodeCharacter_create";
  _gst_default_primitive_table[157].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[157].id = 0;
  _gst_default_primitive_table[157].func = VMpr_UnicodeCharacter_create;
  _gst_default_primitive_table[158].name = "VMpr_Character_equal";
  _gst_default_primitive_table[158].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[158].id = 0;
  _gst_default_primitive_table[158].func = VMpr_Character_equal;
  _gst_default_primitive_table[159].name = "VMpr_Symbol_intern";
  _gst_default_primitive_table[159].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[159].id = 0;
  _gst_default_primitive_table[159].func = VMpr_Symbol_intern;
  _gst_default_primitive_table[160].name = "VMpr_Dictionary_new";
  _gst_default_primitive_table[160].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[160].id = 0;
  _gst_default_primitive_table[160].func = VMpr_Dictionary_new;
  _gst_default_primitive_table[161].name = "VMpr_Memory_addressOfOOP";
  _gst_default_primitive_table[161].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[161].id = 0;
  _gst_default_primitive_table[161].func = VMpr_Memory_addressOfOOP;
  _gst_default_primitive_table[162].name = "VMpr_Memory_addressOf";
  _gst_default_primitive_table[162].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[162].id = 0;
  _gst_default_primitive_table[162].func = VMpr_Memory_addressOf;
  _gst_default_primitive_table[163].name = "VMpr_SystemDictionary_backtrace";
  _gst_default_primitive_table[163].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[163].id = 0;
  _gst_default_primitive_table[163].func = VMpr_SystemDictionary_backtrace;
  _gst_default_primitive_table[164].name = "VMpr_SystemDictionary_getTraceFlag";
  _gst_default_primitive_table[164].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[164].id = 0;
  _gst_default_primitive_table[164].func = VMpr_SystemDictionary_getTraceFlag;
  _gst_default_primitive_table[165].name = "VMpr_SystemDictionary_setTraceFlag";
  _gst_default_primitive_table[165].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[165].id = 0;
  _gst_default_primitive_table[165].func = VMpr_SystemDictionary_setTraceFlag;
  _gst_default_primitive_table[166].name = "VMpr_Memory_at";
  _gst_default_primitive_table[166].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[166].id = 0;
  _gst_default_primitive_table[166].func = VMpr_Memory_at;
  _gst_default_primitive_table[167].name = "VMpr_Memory_atPut";
  _gst_default_primitive_table[167].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[167].id = 0;
  _gst_default_primitive_table[167].func = VMpr_Memory_atPut;
  _gst_default_primitive_table[168].name = "VMpr_Behavior_methodsFor";
  _gst_default_primitive_table[168].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[168].id = 0;
  _gst_default_primitive_table[168].func = VMpr_Behavior_methodsFor;
  _gst_default_primitive_table[169].name = "VMpr_Behavior_methodsForIfTrue";
  _gst_default_primitive_table[169].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[169].id = 0;
  _gst_default_primitive_table[169].func = VMpr_Behavior_methodsForIfTrue;
  _gst_default_primitive_table[170].name = "VMpr_Processor_disableInterrupts";
  _gst_default_primitive_table[170].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[170].id = 0;
  _gst_default_primitive_table[170].func = VMpr_Processor_disableEnableInterrupts;
  _gst_default_primitive_table[171].name = "VMpr_Processor_enableInterrupts";
  _gst_default_primitive_table[171].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[171].id = -1;
  _gst_default_primitive_table[171].func = VMpr_Processor_disableEnableInterrupts;
  _gst_default_primitive_table[172].name = "VMpr_Processor_signalOnInterrupt";
  _gst_default_primitive_table[172].attributes = PRIM_SUCCEED | PRIM_FAIL | PRIM_CHECK_INTERRUPT;
  _gst_default_primitive_table[172].id = 0;
  _gst_default_primitive_table[172].func = VMpr_Processor_signalOnInterrupt;
  _gst_default_primitive_table[173].name = "VMpr_ObjectMemory_getSpaceGrowRate";
  _gst_default_primitive_table[173].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[173].id = 0;
  _gst_default_primitive_table[173].func = VMpr_ObjectMemory_getSpaceGrowRate;
  _gst_default_primitive_table[174].name = "VMpr_ObjectMemory_setSpaceGrowRate";
  _gst_default_primitive_table[174].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[174].id = 0;
  _gst_default_primitive_table[174].func = VMpr_ObjectMemory_setSpaceGrowRate;
  _gst_default_primitive_table[175].name = "VMpr_ObjectMemory_getSmoothingFactor";
  _gst_default_primitive_table[175].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[175].id = 0;
  _gst_default_primitive_table[175].func = VMpr_ObjectMemory_getSmoothingFactor;
  _gst_default_primitive_table[176].name = "VMpr_ObjectMemory_setSmoothingFactor";
  _gst_default_primitive_table[176].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[176].id = 0;
  _gst_default_primitive_table[176].func = VMpr_ObjectMemory_setSmoothingFactor;
  _gst_default_primitive_table[177].name = "VMpr_ObjectMemory_getGrowThresholdPercent";
  _gst_default_primitive_table[177].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[177].id = 0;
  _gst_default_primitive_table[177].func = VMpr_ObjectMemory_getGrowThresholdPercent;
  _gst_default_primitive_table[178].name = "VMpr_ObjectMemory_setGrowThresholdPercent";
  _gst_default_primitive_table[178].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[178].id = 0;
  _gst_default_primitive_table[178].func = VMpr_ObjectMemory_setGrowThresholdPercent;
  _gst_default_primitive_table[179].name = "VMpr_ObjectMemory_getBigObjectThreshold";
  _gst_default_primitive_table[179].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[179].id = 0;
  _gst_default_primitive_table[179].func = VMpr_ObjectMemory_getBigObjectThreshold;
  _gst_default_primitive_table[180].name = "VMpr_ObjectMemory_setBigObjectThreshold";
  _gst_default_primitive_table[180].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[180].id = 0;
  _gst_default_primitive_table[180].func = VMpr_ObjectMemory_setBigObjectThreshold;
  _gst_default_primitive_table[181].name = "VMpr_ObjectMemory_growTo";
  _gst_default_primitive_table[181].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[181].id = 0;
  _gst_default_primitive_table[181].func = VMpr_ObjectMemory_growTo;
  _gst_default_primitive_table[182].name = "VMpr_ObjectMemory_update";
  _gst_default_primitive_table[182].attributes = PRIM_CHECKS_RECEIVER;
  _gst_default_primitive_table[182].id = 0;
  _gst_default_primitive_table[182].func = VMpr_ObjectMemory_update;
  _gst_default_primitive_table[183].name = "VMpr_CObject_allocType";
  _gst_default_primitive_table[183].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[183].id = 0;
  _gst_default_primitive_table[183].func = VMpr_CObject_allocType;
  _gst_default_primitive_table[184].name = "VMpr_Float_sin";
  _gst_default_primitive_table[184].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[184].id = 0;
  _gst_default_primitive_table[184].func = VMpr_Float_sin;
  _gst_default_primitive_table[185].name = "VMpr_Float_cos";
  _gst_default_primitive_table[185].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[185].id = 0;
  _gst_default_primitive_table[185].func = VMpr_Float_cos;
  _gst_default_primitive_table[186].name = "VMpr_Float_tan";
  _gst_default_primitive_table[186].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[186].id = 0;
  _gst_default_primitive_table[186].func = VMpr_Float_tan;
  _gst_default_primitive_table[187].name = "VMpr_Float_arcSin";
  _gst_default_primitive_table[187].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[187].id = 0;
  _gst_default_primitive_table[187].func = VMpr_Float_arcSin;
  _gst_default_primitive_table[188].name = "VMpr_Float_arcCos";
  _gst_default_primitive_table[188].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[188].id = 0;
  _gst_default_primitive_table[188].func = VMpr_Float_arcCos;
  _gst_default_primitive_table[189].name = "VMpr_Float_arcTan";
  _gst_default_primitive_table[189].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[189].id = 0;
  _gst_default_primitive_table[189].func = VMpr_Float_arcTan;
  _gst_default_primitive_table[190].name = "VMpr_Float_exp";
  _gst_default_primitive_table[190].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[190].id = 0;
  _gst_default_primitive_table[190].func = VMpr_Float_exp;
  _gst_default_primitive_table[191].name = "VMpr_Float_ln";
  _gst_default_primitive_table[191].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[191].id = 0;
  _gst_default_primitive_table[191].func = VMpr_Float_ln;
  _gst_default_primitive_table[192].name = "VMpr_Float_pow";
  _gst_default_primitive_table[192].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[192].id = 0;
  _gst_default_primitive_table[192].func = VMpr_Float_pow;
  _gst_default_primitive_table[193].name = "VMpr_CObject_free";
  _gst_default_primitive_table[193].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[193].id = 0;
  _gst_default_primitive_table[193].func = VMpr_CObject_free;
  _gst_default_primitive_table[194].name = "VMpr_Float_sqrt";
  _gst_default_primitive_table[194].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[194].id = 0;
  _gst_default_primitive_table[194].func = VMpr_Float_sqrt;
  _gst_default_primitive_table[195].name = "VMpr_Float_ceil";
  _gst_default_primitive_table[195].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[195].id = 0;
  _gst_default_primitive_table[195].func = VMpr_Float_ceil_floor;
  _gst_default_primitive_table[196].name = "VMpr_Float_floor";
  _gst_default_primitive_table[196].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[196].id = -1;
  _gst_default_primitive_table[196].func = VMpr_Float_ceil_floor;
  _gst_default_primitive_table[197].name = "VMpr_Behavior_basicNewFixed";
  _gst_default_primitive_table[197].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[197].id = 0;
  _gst_default_primitive_table[197].func = VMpr_Behavior_basicNewFixed;
  _gst_default_primitive_table[198].name = "VMpr_Behavior_basicNewFixedColon";
  _gst_default_primitive_table[198].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[198].id = 0;
  _gst_default_primitive_table[198].func = VMpr_Behavior_basicNewFixedColon;
  _gst_default_primitive_table[199].name = "VMpr_Object_tenure";
  _gst_default_primitive_table[199].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[199].id = 0;
  _gst_default_primitive_table[199].func = VMpr_Object_tenure;
  _gst_default_primitive_table[200].name = "VMpr_Object_makeFixed";
  _gst_default_primitive_table[200].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[200].id = 0;
  _gst_default_primitive_table[200].func = VMpr_Object_makeFixed;
  _gst_default_primitive_table[201].name = "VMpr_CObject_derefAt";
  _gst_default_primitive_table[201].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[201].id = 0;
  _gst_default_primitive_table[201].func = VMpr_CObject_at;
  _gst_default_primitive_table[202].name = "VMpr_CObject_at";
  _gst_default_primitive_table[202].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[202].id = -1;
  _gst_default_primitive_table[202].func = VMpr_CObject_at;
  _gst_default_primitive_table[203].name = "VMpr_CObject_atPut";
  _gst_default_primitive_table[203].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[203].id = 0;
  _gst_default_primitive_table[203].func = VMpr_CObject_atPut;
  _gst_default_primitive_table[204].name = "VMpr_CObject_address";
  _gst_default_primitive_table[204].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[204].id = 0;
  _gst_default_primitive_table[204].func = VMpr_CObject_address;
  _gst_default_primitive_table[205].name = "VMpr_CObject_addressColon";
  _gst_default_primitive_table[205].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[205].id = 0;
  _gst_default_primitive_table[205].func = VMpr_CObject_addressColon;
  _gst_default_primitive_table[206].name = "VMpr_CString_replaceWith";
  _gst_default_primitive_table[206].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[206].id = 0;
  _gst_default_primitive_table[206].func = VMpr_CString_replaceWith;
  _gst_default_primitive_table[207].name = "VMpr_ByteArray_fromCData_size";
  _gst_default_primitive_table[207].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[207].id = 0;
  _gst_default_primitive_table[207].func = VMpr_ByteArray_fromCData_size;
  _gst_default_primitive_table[208].name = "VMpr_String_fromCData_size";
  _gst_default_primitive_table[208].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[208].id = 0;
  _gst_default_primitive_table[208].func = VMpr_String_fromCData_size;
  _gst_default_primitive_table[209].name = "VMpr_String_fromCData";
  _gst_default_primitive_table[209].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[209].id = 0;
  _gst_default_primitive_table[209].func = VMpr_String_fromCData;
  _gst_default_primitive_table[210].name = "VMpr_String_asCData";
  _gst_default_primitive_table[210].attributes = PRIM_CHECKS_RECEIVER;
  _gst_default_primitive_table[210].id = 0;
  _gst_default_primitive_table[210].func = VMpr_String_ByteArray_asCData;
  _gst_default_primitive_table[211].name = "VMpr_ByteArray_asCData";
  _gst_default_primitive_table[211].attributes = PRIM_CHECKS_RECEIVER;
  _gst_default_primitive_table[211].id = -1;
  _gst_default_primitive_table[211].func = VMpr_String_ByteArray_asCData;
  _gst_default_primitive_table[212].name = "VMpr_SystemDictionary_byteCodeCounter";
  _gst_default_primitive_table[212].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[212].id = 0;
  _gst_default_primitive_table[212].func = VMpr_SystemDictionary_byteCodeCounter;
  _gst_default_primitive_table[213].name = "VMpr_SystemDictionary_debug";
  _gst_default_primitive_table[213].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[213].id = 0;
  _gst_default_primitive_table[213].func = VMpr_SystemDictionary_debug;
  _gst_default_primitive_table[214].name = "VMpr_Object_isUntrusted";
  _gst_default_primitive_table[214].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[214].id = 0;
  _gst_default_primitive_table[214].func = VMpr_Object_isUntrusted;
  _gst_default_primitive_table[215].name = "VMpr_Object_makeUntrusted";
  _gst_default_primitive_table[215].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[215].id = 0;
  _gst_default_primitive_table[215].func = VMpr_Object_makeUntrusted;
  _gst_default_primitive_table[216].name = "VMpr_Object_isReadOnly";
  _gst_default_primitive_table[216].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[216].id = 0;
  _gst_default_primitive_table[216].func = VMpr_Object_isReadOnly;
  _gst_default_primitive_table[217].name = "VMpr_Object_makeReadOnly";
  _gst_default_primitive_table[217].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[217].id = 0;
  _gst_default_primitive_table[217].func = VMpr_Object_makeReadOnly;
  _gst_default_primitive_table[218].name = "VMpr_Behavior_primCompile";
  _gst_default_primitive_table[218].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[218].id = 0;
  _gst_default_primitive_table[218].func = VMpr_Behavior_primCompile;
  _gst_default_primitive_table[219].name = "VMpr_Behavior_primCompileIfError";
  _gst_default_primitive_table[219].attributes = PRIM_FAIL | PRIM_SUCCEED | PRIM_RELOAD_IP;
  _gst_default_primitive_table[219].id = 0;
  _gst_default_primitive_table[219].func = VMpr_Behavior_primCompileIfError;
  _gst_default_primitive_table[220].name = "VMpr_CCallbackDescriptor_link";
  _gst_default_primitive_table[220].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[220].id = 0;
  _gst_default_primitive_table[220].func = VMpr_CCallbackDescriptor_link;
  _gst_default_primitive_table[221].name = "VMpr_CFuncDescriptor_addressOf";
  _gst_default_primitive_table[221].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[221].id = 0;
  _gst_default_primitive_table[221].func = VMpr_CFuncDescriptor_addressOf;
  _gst_default_primitive_table[222].name = "VMpr_ObjectMemory_snapshot";
  _gst_default_primitive_table[222].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[222].id = 0;
  _gst_default_primitive_table[222].func = VMpr_ObjectMemory_snapshot;
  _gst_default_primitive_table[223].name = "VMpr_Object_basicPrint";
  _gst_default_primitive_table[223].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[223].id = 0;
  _gst_default_primitive_table[223].func = VMpr_Object_basicPrint;
  _gst_default_primitive_table[224].name = "VMpr_Object_makeWeak";
  _gst_default_primitive_table[224].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[224].id = 0;
  _gst_default_primitive_table[224].func = VMpr_Object_makeWeak;
  _gst_default_primitive_table[225].name = "VMpr_Stream_fileInLine";
  _gst_default_primitive_table[225].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[225].id = 0;
  _gst_default_primitive_table[225].func = VMpr_Stream_fileInLine;
  _gst_default_primitive_table[226].name = "VMpr_FileDescriptor_fileOp";
  _gst_default_primitive_table[226].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[226].id = 0;
  _gst_default_primitive_table[226].func = VMpr_FileDescriptor_fileOp;
  _gst_default_primitive_table[227].name = "VMpr_FileDescriptor_socketOp";
  _gst_default_primitive_table[227].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[227].id = 0;
  _gst_default_primitive_table[227].func = VMpr_FileDescriptor_socketOp;
  _gst_default_primitive_table[228].name = "VMpr_CFuncDescriptor_asyncCall";
  _gst_default_primitive_table[228].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[228].id = 0;
  _gst_default_primitive_table[228].func = VMpr_CFuncDescriptor_asyncCall;
  _gst_default_primitive_table[229].name = "VMpr_CFuncDescriptor_call";
  _gst_default_primitive_table[229].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[229].id = 0;
  _gst_default_primitive_table[229].func = VMpr_CFuncDescriptor_call;
  _gst_default_primitive_table[230].name = "VMpr_Object_makeEphemeron";
  _gst_default_primitive_table[230].attributes = PRIM_SUCCEED | PRIM_FAIL;
  _gst_default_primitive_table[230].id = 0;
  _gst_default_primitive_table[230].func = VMpr_Object_makeEphemeron;
  _gst_default_primitive_table[231].name = "VMpr_Namespace_setCurrent";
  _gst_default_primitive_table[231].attributes = PRIM_FAIL;
  _gst_default_primitive_table[231].id = 0;
  _gst_default_primitive_table[231].func = VMpr_Namespace_setCurrent;
  _gst_default_primitive_table[232].name = "VMpr_ObjectMemory_scavenge";
  _gst_default_primitive_table[232].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[232].id = 0;
  _gst_default_primitive_table[232].func = VMpr_ObjectMemory_gcPrimitives;
  _gst_default_primitive_table[233].name = "VMpr_ObjectMemory_compact";
  _gst_default_primitive_table[233].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[233].id = -1;
  _gst_default_primitive_table[233].func = VMpr_ObjectMemory_gcPrimitives;
  _gst_default_primitive_table[234].name = "VMpr_ObjectMemory_globalGarbageCollect";
  _gst_default_primitive_table[234].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[234].id = -2;
  _gst_default_primitive_table[234].func = VMpr_ObjectMemory_gcPrimitives;
  _gst_default_primitive_table[235].name = "VMpr_ObjectMemory_incrementalGCStep";
  _gst_default_primitive_table[235].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[235].id = -3;
  _gst_default_primitive_table[235].func = VMpr_ObjectMemory_gcPrimitives;
  _gst_default_primitive_table[236].name = "VMpr_ObjectMemory_finishIncrementalGC";
  _gst_default_primitive_table[236].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[236].id = -4;
  _gst_default_primitive_table[236].func = VMpr_ObjectMemory_gcPrimitives;
  _gst_default_primitive_table[237].name = "VMpr_SystemDictionary_rawProfile";
  _gst_default_primitive_table[237].attributes = PRIM_SUCCEED;
  _gst_default_primitive_table[237].id = 0;
  _gst_default_primitive_table[237].func = VMpr_SystemDictionary_rawProfile;

  for (i = 238; i < NUM_PRIMITIVES; i++)
    {
