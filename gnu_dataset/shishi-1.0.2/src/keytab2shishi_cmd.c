...
const char *gengetopt_args_info_help[] = {
  ...
  "  -R, --reverse  Reverse action, read Shishi hostkeys from INFILE and write \n                   keytab data to OUTFILE.  (default=off)",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->reverse_help = gengetopt_args_info_help[2] ;
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'R':	/* Reverse action, read Shishi hostkeys from INFILE and write keytab data to OUTFILE..  */
