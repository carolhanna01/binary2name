...
#define CMDLINE_PARSER_PACKAGE_NAME "keytab2shishi"
#endif
...
struct gengetopt_args_info
{
  ...
  int reverse_flag;	/**< @brief Reverse action, read Shishi hostkeys from INFILE and write keytab data to OUTFILE. (default=off).  */
  const char *reverse_help; /**< @brief Reverse action, read Shishi hostkeys from INFILE and write keytab data to OUTFILE. help description.  */
