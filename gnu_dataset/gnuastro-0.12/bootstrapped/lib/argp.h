...
struct argp_option
{
  ...
  /* Pointer to value.
     IMPORTANT: A Gnuastro addition. */
  void *value;

  /* Type of value (see lib/gnuastro/data.h).
     IMPORTANT: A Gnuastro addition. */
  int type;

  /* Acceptable range of value (see lib/options.h).
     IMPORTANT: A Gnuastro addition. */
  int range;

  /* Is this option mandatory? (see lib/options.h).
     IMPORTANT: A Gnuastro addition. */
  unsigned char mandatory;

  /* Is value already set or not? (see lib/options.h).
     IMPORTANT: A Gnuastro addition. */
  unsigned char set;

  /* Function to process the given value.
     Arguments to the function:
       struct argp_option *option: This argp_option.
       char      *arg: String given by the user.
       char *filename: Filename option was read from.
       size_t  lineno: Line number of option in file.
       void   *struct: Pointer to main program struct.
