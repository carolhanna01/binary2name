...
# Copyright (C) 2004, 2005, 2006, 2007  Tom Cato Amundsen
#
...
gtk.stock_add([('solfege-notehead', _("Add noteheads"), 0, 0, ''),
               ('solfege-sharp', _("Add sharp"), 0, 0, ''),
               ('solfege-double-sharp', _("Add double-sharp"), 0, 0, ''),
               ('solfege-natural', _("Remove accidentals"), 0, 0, ''),
               ('solfege-flat', _("Add flat"), 0, 0, ''),
               ('solfege-double-flat', _("Add double-flat"), 0, 0, ''),
               ('solfege-erase', _("Delete tone"), 0, 0, ''),
               ])
app_version = "0.1.4"
...
lessonfile_actions = [
    ...
    ('EraseCursor', 'solfege-erase', None, None,
     _('Erase tones'), 'select_cursor_erase_cb'),
]
ui_string = """<ui>
