...
/*
** This is the header for Brahma implemented using Solaris threads
** and Sparc V7 spinlocks.
*/

#ifndef _SMP_SOLARIS_H_
#define _SMP_SOLARIS_H_

#ifndef _REENTRANT
#define _REENTRANT
#endif

#ifdef BR_SMP_SOLARIS_IMPL
# define EXTERNAL
#else
...
/* include Solaris thread and synchronization stuff common across all
 * Solaris based platforms 
 */
#include "../solaris_common/solaris_sync.h"

/* Deal with active messages and things that vary across different Solaris
 * platforms (such BR_freeze and BR_thaw, BR_init and BR_exit, etc.  
 */
...
EXTERNAL void BR_enqueue_fork(BR_cluster_t, BR_handler_t, BR_word_t, BR_word_t, BR_word_t,BR_word_t,BR_word_t);

#define BR_FORK_0(c,f) 		BR_enqueue_fork(c,(BR_handler_t)f,0,0,0,0,0)
#define BR_FORK_1(c,f,a) 	BR_enqueue_fork(c,(BR_handler_t)f,a,0,0,0,0)
#define BR_FORK_2(c,f,a,b) 	BR_enqueue_fork(c,(BR_handler_t)f,a,b,0,0,0)
#define BR_FORK_3(c,f,a,b,d) 	BR_enqueue_fork(c,(BR_handler_t)f,a,b,d,0,0)
#define BR_FORK_4(c,f,a,b,d,e) 	BR_enqueue_fork(c,(BR_handler_t)f,a,b,d,e,0)
#define BR_FORK_5(c,f,a,b,d,e,g) BR_enqueue_fork(c,(BR_handler_t)f,a,b,d,e,g)


#define BR_ASCII_PLATFORM() "smp_solaris"
