...
** Solaris
*/
#ifndef _TCP_SOLARIS_H_
#define _TCP_SOLARIS_H_

#ifndef _REENTRANT
#define _REENTRANT
#endif

#ifdef BR_TCP_SOLARIS_IMPL
# define EXTERNAL
#else
...
#include "../solaris_common/brahma2am.h"    /* Communication stuff */
#include "../solaris_common/solaris_sync.h" /* Threads and synchronization stuff */
