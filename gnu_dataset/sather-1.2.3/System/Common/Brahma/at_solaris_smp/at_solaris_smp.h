...
#ifndef _AT_SOLARIS_SMP_H_
#define _AT_SOLARIS_SMP_H_


#ifdef BR_AT_SOLARIS_SMP_IMPL
# define EXTERNAL
#else
...
#define BR_FORK_3(c,f,a,b,d) 	 tids[at_thr_num]=at_create_4(at_get_focus(),AT_UNBOUND,(at_userf_4_t*)f,BR_HERE(),a,b,d)
...
#define BR_ASCII_PLATFORM() "ActiveThread_solaris_smp"
