 ...
 *
 *	$Id: db.h.in,v 1.7 2000/10/25 12:32:19 loic Exp $
 */
...
struct __db_cmpr_info {
	...
	__P((DB_ENV *, const u_int8_t*, int, u_int8_t**, int*,void *));
...
/*
 * Flags understood by both CDB_db_env_create and CDB_db_create.
 */
#define	DB_CXX_NO_EXCEPTIONS  0x000001	/* C++: return error values. */

/*
 * Flags understood by only CDB_db_env_create.
 */
...
#define DB_COMPRESS	      0x000200  /* Transparent I/O compression */
 ...
 * used by CDB___bam_vrfy_subtree.
 */
...
#define	DB_VERB_WAITSFOR	0x0008	/* Dump waits-for table. */
	...
	void	       * mp_monitor;    /* Monitoring tool. */
	void	       * app_private;   /* Private application pointer. */
...
#define	DB_ENV_CMPR		0x02000	/* Compression active. */
...
#define	DB_CHECKPOINT	 5		/* CDB_log_put(), CDB_log_get() */
#define	DB_CONSUME	 6		/* c_get() */
#define	DB_CURLSN	 7		/* CDB_log_put() */
#define	DB_CURRENT	 8		/* c_get(), c_put(), CDB_log_get() */
...
#define	DB_LAST		17		/* c_get(), CDB_log_get() */
#define	DB_NEXT		18		/* c_get(), CDB_log_get() */
...
#define	DB_PREV		26		/* c_get(), CDB_log_get() */
#define	DB_PREV_NODUP	27		/* c_get(), CDB_log_get() */
#define	DB_RECORDCOUNT	28		/* stat() */
#define	DB_SET		29		/* c_get(), CDB_log_get() */
...
#define	DB_LOGFILEID_INVALID	-1
	 ...
	 * undocumented interface to support this CDB_usage which leaves any file
...
#define DB_AM_CMPR	0x40000         /* Transparent I/O compression */
	u_int32_t flags;
        u_int8_t tags;			/* User defined tag, 0xf0 in page */
};
...
int   CDB_db_env_set_func_fsync __P((int (*)(int)));
int   CDB_db_env_set_func_ioinfo __P((int (*)(const char *,
...
int   CDB_db_env_set_pageyield __P((int));
int   CDB_db_env_set_panicstate __P((int));
int   CDB_db_env_set_region_init __P((int));
