 ...
 *
 * $Id: db_page.h,v 1.4 2014/04/17 20:27:27 sebdiaz Exp $
 */
...
#define SSZ8(name, field) (*(int *) (&(((name *)0)->field)))

#define	HOFFPAGE_PGNO(p)	(((u_int8_t *)p) + SSZ8(HOFFPAGE, pgno))
#define	HOFFPAGE_TLEN(p)	(((u_int8_t *)p) + SSZ8(HOFFPAGE, tlen))
...
#define	HOFFDUP_PGNO(p)		(((u_int8_t *)p) + SSZ8(HOFFDUP, pgno))
