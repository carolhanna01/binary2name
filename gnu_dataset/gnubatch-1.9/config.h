...
/* Define if sigset routines do not delete held pending signals in child
   processes */
/* #undef BUGGY_SIGSET_HOLDS */
...
/* /Set if arg to getgroups is same as gid_t */
#define GETGROUPS_SAME_SIZE 1
...
/* Define if directory-reading stuff has dd_fd in dir structure */
/* #undef HAVE_DD_FD */
...
/* Define if directory-reading stuff has dirfd funct/macro */
#define HAVE_DIRFD 1
...
/* Define if XML library libxml2 is available */
/* #undef HAVE_LIBXML2 */
...
/* Define to set initial variable allocation */
/* #undef INITVALLOC */
...
/* Define if sigaction structure doesn't have sa_sigaction in */
/* #undef NO_SA_SIGACTION */

/* Define if curses.h doesn't include termio.h */
#define NO_TERMIO_IN_CURSES 1

/* Define to maximum number of semaphores at once */
#define NUMSEMA4 200
...
#define PACKAGE_NAME "src/btsched.c"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "src/btsched.c 1.9"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "src-btsched-c"
