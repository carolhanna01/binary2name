...
typedef struct {
	...
	/* int firstM; */
	/* int remainsM; */
        char * mtM;   /* TRAILER string */
        /* char * mtpM; */  /* position in trailer string */
        /* int mt_nullsM; */ /* Number of NULs interspersed trailer string */
	/* int mt_spanM; */  /* block span of trailer string */
} SYNCT;
...
unsigned long int swlib_atoul(const char *nptr, int * result);
