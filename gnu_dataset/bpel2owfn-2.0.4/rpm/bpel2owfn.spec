...
Packager:  Niels Lohmann <nlohmann@informatik.hu-berlin.de>
Autoreq:   1
...
%description
BPEL2oWFN does something useful.
...
%changelog
* %{date} Niels Lohmann <nlohmann@informatik.hu-berlin.de>
