...
echo "    ${cmdname} viewer"
echo ""
echo "  Run the icecat-bin binary"
echo ""
echo "    ${cmdname} icecat-bin"
echo ""
echo "  Debug the viewer in a debugger"
echo ""
echo "    ${cmdname} -g viewer"
echo ""
echo "  Debug the icecat-bin binary in gdb"
echo ""
echo "    ${cmdname} -g icecat-bin -d gdb"
echo ""
	return 0
}
##########################################################################
